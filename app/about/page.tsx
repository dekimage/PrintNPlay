    ...
    <div className="min-h-screen py-16">
      <div className="container max-w-4xl">
        ...
        <div className="prose prose-invert prose-lg max-w-none mb-16">
          ...
          <ul>
            <li>
              <strong>Small:</strong> Compact games that don't overwhelm new
              players
            </li>
            <li>
              <strong>Fast:</strong> Quick setup and play sessions that respect
              your time
            </li>
            <li>
              <strong>Fun:</strong> Engaging mechanics that prioritize enjoyment
              over complexity
            </li>
          </ul>
          ...
          <p>
            ...
            being small, fast, and fun. We're committed to supporting the indie
            TTRPG community and making our hobby more inclusive and accessible.
          </p>
        </div>
        ...
        <div className="mt-16 p-8 bg-white/5 rounded-lg border border-white/10 text-center">
          ...
          <p className="text-white/80 mb-6">
            ...
            games, feedback, or just want to say hello, don't hesitate to reach
            out.
          </p>
          <a
            href="/contact"
